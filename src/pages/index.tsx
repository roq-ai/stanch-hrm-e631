...
function HomePage() {
  return (
    <>
      <Head>
        <title>{`Stanch-HRM`}</title>

        <meta
          name="description"
          content="Welcome to Stanch-HRM: Your comprehensive solution for HRM, Payroll, taxes, leave and attendance management all in one application."
        />
      </Head>
      <HomeLayout>
        <Box position="relative" display="flex" flex={{ lg: '0 0 485px' }} height={{ base: '180px', lg: 'auto' }}>
          <Image
            flex="1"
            src={
              'https://images.unsplash.com/photo-1526304640581-d334cdbbf45e?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&ixid=M3w0NjA3NjB8MHwxfHNlYXJjaHwxfHxIUk0lMkNwYXlyb2xsJTJDdGF4ZXN8ZW58MHx8fHwxNjg5ODQ3MTYyfDA&ixlib=rb-4.0.3&q=80&w=1080'
            }
            alt="Dinner"
            objectFit="cover"
          ...
          <Box position="absolute" top="0" backgroundColor="rgba(0,0,0,0.6)" width="100%" py="2">
            <Text align="center" fontSize="sm" color="white">
              Photo by{' '}
              <Link
                href="https://unsplash.com/@sharonmccutcheon?utm_source=roq-generator&utm_medium=referral"
                isExternal
                color="teal.200"
              >{`Alexander Grey`}</Link>{' '}
              on{' '}
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to Stanch-HRM: Your comprehensive solution for HRM, Payroll, taxes, leave and attendance management all in one application.`}
            </Text>
            <Box
